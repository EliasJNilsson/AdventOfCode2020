...
namespace Day7
{
    class Program
    {
        //https://github.com/DjolenceTipic/Advent-of-Code/blob/main/Advent-of-Code-2020/day-7/Program.cs
        static List<string> final = new List<string>();
        static void Main(string[] args)
        {
            var input = System.IO.File.ReadAllLines(@"..\..\..\input.txt");
            var bagsRecepies = ParseBags(input);
...
//            //Make input into Dictionary<Key, List<Key,val>>
//            var readyInput = ParseBags(input);
//            ;
